...
#Обнуление словоря после нажатия на кнопку - Юр.консультацию
user_choice = {}
#Фукция проверки повторного нажатия кнопки
...
#Обработка, чтобы не отправлялись кнопки в сообщениях и обнуление var_button_legal
