...
get_help_not_understand = '''🤷‍♂️Вибачте, але я розумію тільки текстові звернення! Прохання не спамити!
Для того, щоб повторити відправку текстового звернненя, Вам потрібно перезайти в цей розділ!'''

eng_get_help_not_understand = '''🤷‍♂️Sorry, but I only understand text appeals! Please do not spam! 
To resend a text message, You need to switch to this section!'''
